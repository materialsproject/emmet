...
conda activate base;
module load esslurm;
emmet --sbatch --yes --run --issue 87 tasks -d $SCRATCH/projects upload-to-nomad --nomad-configfile /global/homes/m/mwu1011/projects/driver_scripts/nomad_config.json -n -1

...
class FindStructureQuery(QueryOperator):
    ...
    def query(
        ...
        try:
            ...
            raise HTTPException(status_code=404, detail="Body cannot be converted to a pymatgen structure object.")
...
class FormulaAutoCompleteQuery(QueryOperator):
    ...
    def query(
        ...
        try:
            ...
            raise HTTPException(status_code=400, detail="Invalid formula provided.")

...
def test_convert_value():
    ...
    product = {"min_value": None, "max_value": 350.0, "values": [350.0], "units": "°C"}
    ...
    assert get_material_formula(
        {
            ...
            "composition": [
                {"formula": "NH4H2PO4", "amount": "1", "elements": {"N": "1", "H": "6", "P": "1", "O": "4"}}
            ],
        }
    ...
    assert get_material_formula(
        {
            ...
            "composition": [
                ...
                {"formula": "BaCO3", "amount": "2", "elements": {"Ba": "1", "C": "1", "O": "3"}},
            ],
        }
...
def test_convert_one():
    with open(os.path.join(MAPISettings(DB_VERSION="").TEST_FILES, "synth_doc_adaptor_synpro.json")) as file:
        synth_doc = load(file)

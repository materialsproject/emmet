...
def test_bulk_modulus_query():
    ...
    q = op.query(k_voigt_min=0, k_voigt_max=5, k_reuss_min=0, k_reuss_max=5, k_vrh_min=0, k_vrh_max=5)
    ...
    with ScratchDir("."):
        ...
        q = new_op.query(k_voigt_min=0, k_voigt_max=5, k_reuss_min=0, k_reuss_max=5, k_vrh_min=0, k_vrh_max=5)
        assert q == {"criteria": {field: {"$gte": 0, "$lte": 5} for field in fields}}
...
def test_shear_modulus_query():
    ...
    q = op.query(g_voigt_min=0, g_voigt_max=5, g_reuss_min=0, g_reuss_max=5, g_vrh_min=0, g_vrh_max=5)
    ...
    with ScratchDir("."):
        dumpfn(op, "temp.json")
        new_op = loadfn("temp.json")
        q = new_op.query(g_voigt_min=0, g_voigt_max=5, g_reuss_min=0, g_reuss_max=5, g_vrh_min=0, g_vrh_max=5)
        assert q == {"criteria": {field: {"$gte": 0, "$lte": 5} for field in fields}}
...
def test_poisson_query():
    ...
    q = op.query(elastic_anisotropy_min=0, elastic_anisotropy_max=5, poisson_min=0, poisson_max=5)
    ...
    with ScratchDir("."):
        dumpfn(op, "temp.json")
        new_op = loadfn("temp.json")
        q = new_op.query(elastic_anisotropy_min=0, elastic_anisotropy_max=5, poisson_min=0, poisson_max=5)
        assert q == {"criteria": {field: {"$gte": 0, "$lte": 5} for field in fields}}

import os
from emmet.api.routes.mpcomplete.query_operator import MPCompleteGetQuery, MPCompletePostQuery
...
def test_mpcomplete_post_query():
    ...
    with ScratchDir("."):
        ...
        assert (
            new_op.query(structure=structure.as_dict(), public_name="Test Test", public_email="test@test.com") == query
        )

    docs = [{"structure": structure.as_dict(), "public_name": "Test Test", "public_email": "test@test.com"}]

...
boltztrap4dos_mat = os.path.join(
    module_dir, "..", "..", "..", "test_files", "boltztrap4dos_mat.json"
)
boltztrap4dos_bs = os.path.join(
    module_dir, "..", "..", "..", "test_files", "boltztrap4dos_bs.json"
)
boltztrap4dos_dos = os.path.join(
    module_dir, "..", "..", "..", "test_files", "boltztrap4dos_dos.json"
)
...
class TestBoltztrap4DosBuilder(unittest.TestCase):
    ...
    def test_process_items(self):
        dosbuilder = Boltztrap4DosBuilder(
            self.materials, self.bandstructure, self.dos, avoid_projections=True
        )

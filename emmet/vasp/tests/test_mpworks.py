...
from emmet.vasp.mpworks import (
    MPWorksCompatibilityBuilder,
    convert_mpworks_to_atomate,
    update_mpworks_schema,
)
...
test_tasks = os.path.join(
    module_dir, "..", "..", "..", "test_files", "mpworks_tasks.json"
)
...
class MPWorksCompatibilityBuilderTest(unittest.TestCase):
    ...
    def test_builder(self):
        mpw_builder = MPWorksCompatibilityBuilder(
            self.test_tasks, self.elasticity, incremental=False
        )

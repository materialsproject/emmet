...
test_tasks = os.path.join(
    module_dir, "..", "..", "..", "test_files", "new_sample_qchem_tasks.json"
)
assoc_tasks = os.path.join(
    module_dir, "..", "..", "..", "test_files", "LiEC_tasks.json"
)
    ...
    def test_get_and_process(self):
        ...
        for group in grouped_tasks:
            ...
            if group[0]["formula_pretty"] == "H2C":
                ...
                group[0]["formula_pretty"] == "H5C2Cl"
                or group[0]["formula_pretty"] == "BH4"
            ):
                self.assertEqual(len(mols), 4)
            else:
...
class TestAssocMolecules(unittest.TestCase):
    ...
    def test_get_and_process(self):
        ...
        self.assertEqual(
            mols[0]["environment"], "smd_18.5,1.415,0.00,0.735,20.2,0.00,0.00"
        )

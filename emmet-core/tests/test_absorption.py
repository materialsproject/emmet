...
def absorption_test_doc(absorption_test_data):
    ...
    doc = AbsorptionDoc.from_structure(
        ...
        task_id=task_id,
        deprecated=False,
        energies=absorption_test_data["output"]["dielectric"]["energy"],
        real_d=absorption_test_data["output"]["dielectric"]["real"],
        imag_d=absorption_test_data["output"]["dielectric"]["imag"],
        absorption_co=absorption_test_data["output"]["optical_absorption_coeff"],

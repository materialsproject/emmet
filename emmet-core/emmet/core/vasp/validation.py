...
from emmet.core.tasks import ProductionTaskDoc, TaskDoc
...
class ValidationDoc(EmmetBaseModel):
    ...
    def from_task_doc(
        cls,
        task_doc: ProductionTaskDoc | TaskDoc | TaskDocument,
...
def _magmom_check(
    ...
    if isinstance(calc, CalculationOutput):

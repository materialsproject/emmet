...
# pymatgen.entries.computed_entries.EnergyAdjustment.__type_adapter__ = (
#     EnergyAdjustmentAdatper
# )
# pymatgen.entries.computed_entries.ConstantEnergyAdjustment.__type_adapter__ = (
#     ConstantEnergyAdjustmentAdatper
# )
# pymatgen.entries.computed_entries.ManualEnergyAdjustment.__type_adapter__ = (
#     ManualEnergyAdjustmentAdatper
# )
# pymatgen.entries.computed_entries.CompositionEnergyAdjustment.__type_adapter__ = (
#     CompositionEnergyAdjustmentAdatper
# )
# pymatgen.entries.computed_entries.TemperatureEnergyAdjustment.__type_adapter__ = (
#     TemperatureEnergyAdjustmentAdatper
# )
pymatgen.entries.computed_entries.ComputedEntry.__type_adapter__ = ComputedEntryAdapter
pymatgen.entries.computed_entries.ComputedStructureEntry.__type_adapter__ = (

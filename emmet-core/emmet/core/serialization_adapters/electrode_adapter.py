...
pymatgen.apps.battery.insertion_battery.InsertionVoltagePair.__type_adapter__ = (
    InsertionVoltagePairAdapter
)
pymatgen.apps.battery.insertion_battery.InsertionElectrode.__type_adapter__ = (
    InsertionElectrodeAdapter
)
pymatgen.apps.battery.conversion_battery.ConversionElectrode.__type_adapter__ = (

...
pymatgen.apps.battery.insertion_battery.InsertionVoltagePair.__pydantic_model__ = (
    InsertionVoltagePairAdapter
)
pymatgen.apps.battery.insertion_battery.InsertionElectrode.__pydantic_model__ = (
    InsertionElectrodeAdapter
)
pymatgen.apps.battery.conversion_battery.ConversionElectrode.__pydantic_model__ = (

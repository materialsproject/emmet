...
pymatgen.entries.compatibility.Compatibility.__type_adapter__ = CompatibilityAdapter
pymatgen.entries.compatibility.MaterialsProject2020Compatibility.__type_adapter__ = (
    MaterialsProject2020CompatibilityAdapter
)
pymatgen.entries.compatibility.MaterialsProjectAqueousCompatibility.__type_adapter__ = (

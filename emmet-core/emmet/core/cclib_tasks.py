...
class TaskDocument(MoleculeMetadata):
    ...
    def from_logfile(
        ...
        # specified directory.
        logfile = _find_recent_logfile(dir_name, logfile_extensions)
        if not logfile:
        ...
        if analysis:
            ...
            cubefile_path = _find_recent_logfile(dir_name, [".cube", ".cub"])
...
def _find_recent_logfile(dir_name: Path | str, logfile_extensions: str | list[str]):
    """
